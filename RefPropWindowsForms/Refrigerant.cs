        ...
        public Refrigerant(RefrigerantCategory refrigerantCategory, string refrigerantName,ReferenceState reference)
        {
            ...
            else if (refrigerantCategory == RefrigerantCategory.NewMixture)
            {
                ...
                for (int i = 0; i < a.Length; i++)
                {
                    ...
                    //c = temp + "C:\\Users\\luisc\\Desktop\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\RefPropWindowsForms\\RefPropWindowsForms\\fluids\\" + luis + ".fld|";
                    c =temp+ luis+ ".fld|";
                    temp = c;
                }
                mezcla = "siMEZCLA";
