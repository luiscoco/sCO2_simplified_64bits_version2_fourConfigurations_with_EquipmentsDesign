...
{
    public partial class TOPGEN_V3 : Form
    {

        Refrigerant working_fluid;
        ...
        //REAL Radial_Turbine Thermodynamic Operation Conditions 
        public Double P_Total_outlet_real, T_total_outlet_real, H_total_outlet_real, S_total_outlet_real, H_total_outlet_real_isoentropic;
        public Double total_entalphy_difference_real;
        public Double power_real, pressure_ratio_real;
        ...
        //Pointers to power cycles for exporting the Radial Turbine Results and calculating the Power cycle Real Performance 
        ...
        public Double [] flow_coefficient_array = new Double [2000];
        public Double [] head_coefficient_array = new Double [2000];
        public Double [] turbine_efficiency_array = new Double [2000];
        public Double[] turbine_number_array = new Double [2000];

        public TOPGEN_V3()
        {
            InitializeComponent();

            working_fluid = new Refrigerant(RefrigerantCategory.NewMixture, this.comboBox2.Text + "=" + textBox10.Text + "," + this.comboBox4.Text + "=" + textBox9.Text, ReferenceState.DEF);

        }

        // RC_Design_WithReHeating: Brayton_cycle_type_variable = 2
        public void Sending_Pointer_RC_Design_withReHeating(Recompression_Brayton_Power_Cycle Punterociclo2, Double Brayton_cycle_type)
        {
        ...
        public void Sending_Pointer_RC_Design_withoutReHeating(RC_without_ReHeating Punterociclo4, Double Brayton_cycle_type)
        {
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        public void Sending_Pointer_PCRC_Design_withReHeating(PCRC Punterociclo6, Double Brayton_cycle_type)
        {
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        public void Sending_Pointer_PCRC_Design_withoutReHeating(PCRC_without_ReHeating Punterociclo8, Double Brayton_cycle_type)
        {
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        public void Sending_Pointer_RCMCI_Design_withReHeating(RCMCI Punterociclo10, Double Brayton_cycle_type)
        {
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        public void Sending_Pointer_RCMCI_Design_withoutReHeating(RCMCI_without_ReHeating Punterociclo12, Double Brayton_cycle_type)
        {
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Rotor_Calculation_function(0,0);

            Stator_Calculation_function();

            Enthalpy_Looses_Calculation_function();

            Feasibility_Check_function();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            xlWorkBook = xlApp.Workbooks.Open(this.textBox30.Text, 0, false, 5, "", "", false, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "", true, false, 0, true, false, false);

            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Worksheets.get_Item(2);

            flow_coefficient = Convert.ToDouble(xlWorkSheet.get_Range("C2").Value2);
            this.textBox22.Text = Convert.ToString(flow_coefficient);
            head_coefficient = Convert.ToDouble(xlWorkSheet.get_Range("D2").Value2);
            this.textBox23.Text = Convert.ToString(head_coefficient);
            rotational_speed = Convert.ToDouble(xlWorkSheet.get_Range("E2").Value2);
            this.textBox24.Text = Convert.ToString(rotational_speed);
            power = Convert.ToDouble(xlWorkSheet.get_Range("P2").Value2) / 1000;
            this.textBox20.Text = Convert.ToString(power);

            P_total_inlet = Convert.ToDouble(xlWorkSheet.get_Range("K2").Value2) / 1000;
            this.textBox1.Text = Convert.ToString(P_total_inlet);
            T_total_inlet = Convert.ToDouble(xlWorkSheet.get_Range("I2").Value2);
            this.textBox2.Text = Convert.ToString(T_total_inlet);
            P_total_outlet = Convert.ToDouble(xlWorkSheet.get_Range("AK2").Value2) / 1000;
            this.textBox18.Text = Convert.ToString(P_total_outlet);
            T_total_outlet = Convert.ToDouble(xlWorkSheet.get_Range("AH2").Value2);
            ...
            //xlWorkBook.SaveAs("C:\\Users\\luisc\\Desktop\\sCO2 Heat Balances C#\\turbine_compare_V3.xlsx");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            xlWorkSheet1.Cells[2, 1] = Convert.ToString(comboBox2.Text + "=" + textBox10.Text + "," + comboBox4.Text + "=" + textBox9.Text);
            xlWorkSheet1.Cells[2, 2] = Convert.ToString(1);
            xlWorkSheet1.Cells[2, 3] = Convert.ToString(flow_coefficient);
            xlWorkSheet1.Cells[2, 4] = Convert.ToString(head_coefficient);
            xlWorkSheet1.Cells[2, 5] = Convert.ToString(rotational_speed);
            xlWorkSheet1.Cells[2, 6] = "REAL";
            xlWorkSheet1.Cells[2, 7] = Convert.ToString(total_entalphy_difference);
            xlWorkSheet1.Cells[2, 8] = Convert.ToString(static_enthalpy_difference);
            xlWorkSheet1.Cells[2, 9] = Convert.ToString(T_total_inlet);
            xlWorkSheet1.Cells[2, 10] = Convert.ToString(T_static_inlet);
            ...
            //Head_Coefficient
            //xlWorkSheet1.Cells[2, 4] = Convert.ToString(head_coefficient);
            //Turbine_Rotor_Rotational_Speed
            //xlWorkSheet1.Cells[2, 5] = Convert.ToString(rotational_speed);
            //REFPROP_Treatment
            //xlWorkSheet1.Cells[2, 6] = "REAL";
            //total_enthalpy_difference
            //xlWorkSheet1.Cells[2, 7] = Convert.ToString(total_entalphy_difference);
            //static_enthalpy_difference
            //xlWorkSheet1.Cells[2, 8] = Convert.ToString(static_enthalpy_difference);
            //T_total_inlet
            //xlWorkSheet1.Cells[2, 9] = Convert.ToString(T_total_inlet);
            //T_static_inlet
            //xlWorkSheet1.Cells[2, 10] = Convert.ToString(T_static_inlet);
            //P_total_inlet
            //xlWorkSheet1.Cells[2, 11] = Convert.ToString(P_total_inlet);
            //P_static_inlet
            //xlWorkSheet1.Cells[2, 12] = Convert.ToString(P_static_inlet);
            //rho_total_inlet
            //xlWorkSheet1.Cells[2, 13] =
            //rho_static_inlet
            //xlWorkSheet1.Cells[2, 14] =
            //Mass_Flow_Rate
            //xlWorkSheet1.Cells[2, 15] =
            //Power
            //xlWorkSheet1.Cells[2, 16] =
            //Cp
            //xlWorkSheet1.Cells[2, 17] =
            //Viscosity
            //xlWorkSheet1.Cells[2, 18] =
            //gama
            //xlWorkSheet1.Cells[2, 19] =
            //Molar_Mass
            //xlWorkSheet1.Cells[2, 20] =
            //U_inlet
            //xlWorkSheet1.Cells[2, 21] =
            //C_inlet
            //xlWorkSheet1.Cells[2, 22] =
            //Ctheta_inlet
            //xlWorkSheet1.Cells[2, 23] =
            //Cm_inlet
            //xlWorkSheet1.Cells[2, 24] =
            //W_inlet
            //xlWorkSheet1.Cells[2, 25] =
            //alpha_inlet
            //xlWorkSheet1.Cells[2, 26] =
            //beta_inlet
            //xlWorkSheet1.Cells[2, 27] =
            //radius_inlet  
            //xlWorkSheet1.Cells[2, 28] =
            //blade_height_inlet
            //xlWorkSheet1.Cells[2, 29] =
            //area_inlet
            //xlWorkSheet1.Cells[2, 30] =
            //area_critical_inlet
            //xlWorkSheet1.Cells[2, 31] =
            //Mach_absolute_inlet
            //xlWorkSheet1.Cells[2, 32] =
            //Mach_relative_inlet
            //xlWorkSheet1.Cells[2, 33] =
            //T_total_outlet
            //xlWorkSheet1.Cells[2, 34] =
            //T_total_relative_rms_outlet
            //xlWorkSheet1.Cells[2, 35] =
            //T_static_outlet
            //xlWorkSheet1.Cells[2, 36] =
            //P_total_outlet
            //xlWorkSheet1.Cells[2, 37] =
            //P_total_relative_rms_outlet
            //xlWorkSheet1.Cells[2, 38] =
            //P_static_outlet
            //xlWorkSheet1.Cells[2, 39] =
            //rho_total_outlet
            //xlWorkSheet1.Cells[2, 40] =
            //rho_static_outlet
            //xlWorkSheet1.Cells[2, 41] =
            //Total_static_pressure_ratio
            //xlWorkSheet1.Cells[2, 42] =
            //U_rms_outlet
            //xlWorkSheet1.Cells[2, 43] =
            //U_tip_outlet
            //xlWorkSheet1.Cells[2, 44] =
            //U_hub_outlet
            //xlWorkSheet1.Cells[2, 45] =
            //C_outlet
            //xlWorkSheet1.Cells[2, 46] =
            //Ctheta_outlet
            //xlWorkSheet1.Cells[2, 47] =
            //Cm_outlet
            //xlWorkSheet1.Cells[2, 48] =
            //W_rms_outlet
            //xlWorkSheet1.Cells[2, 49] =
            //W_tip_outlet
            //xlWorkSheet1.Cells[2, 50] =
            //W_hub_outlet
            //xlWorkSheet1.Cells[2, 51] =
            //beta_rms_outlet
            //xlWorkSheet1.Cells[2, 52] =
            //beta_tip_outlet
            //xlWorkSheet1.Cells[2, 53] =
            //beta_hub_outlet
            //xlWorkSheet1.Cells[2, 54] =
            //rotor_radius_mean_outlet
            //xlWorkSheet1.Cells[2, 55] =
            //radius_rms_outlet
            //xlWorkSheet1.Cells[2, 56] =
            //radius_tip_outlet
            //xlWorkSheet1.Cells[2, 57] =
            //radius_hub_outlet
            //xlWorkSheet1.Cells[2, 58] =
            //blade_height_outlet
            //xlWorkSheet1.Cells[2, 59] =
            //area_outlet
            //xlWorkSheet1.Cells[2, 60] =
            //rotor_outlet_area
            //xlWorkSheet1.Cells[2, 61] =
            //rotor_outlet_area_total
            //xlWorkSheet1.Cells[2, 62] =
            //rotor_outlet_rms_length
            //xlWorkSheet1.Cells[2, 63] =
            //rotor_outlet_length_rms_total
            //xlWorkSheet1.Cells[2, 64] =
            //area_critical_outlet
            //xlWorkSheet1.Cells[2, 65] =
            //Mach_absolute_outlet
            //xlWorkSheet1.Cells[2, 66] =
            //Mach_relative_rms_outlet
            //xlWorkSheet1.Cells[2, 67] =
            //Mach_relative_tip_outlet
            //xlWorkSheet1.Cells[2, 68] =
            //Mach_relative_hub_outlet
            //xlWorkSheet1.Cells[2, 69] =
            //number_blades
            //xlWorkSheet1.Cells[2, 70] =
            //rotor_chord
            //xlWorkSheet1.Cells[2, 71] =
            //rotor_full_length

            //rotor_meridional_length

            //rotor_trailing_edge_thickness
            ...
            //radius_ratio_inlet_outlet_tip

            //rotor_tip_inlet_tip_outlet_length
            ...
            //Incidence_Loss_Contribution

            //Passage_Loss

            //Passage_Loss_Contribution

            //Trailing_Edge_Loss

            //Trailing_Edge_Loss_Contribution

            //Exit_Energy_Loss

            //Exit_Energy_Loss_Contribution

            //Tip_Clearance_Loss

            //Tip_Clearance_Loss_Contribution

            //Windage_Loss

            //Windage_Loss_Contribution

            //stator_T_total_inlet

            //stator_T_static_inlet

            //stator_P_total_inlet

            //stator_P_static_inlet

            //stator_rho_total_inlet

            //stator_rho_static_inlet
            ...
            //stator_inlet_x_coordinate

            //stator_inlet_y_coordinate

            //stator_area_inlet

            //stator_area_inlet_total

            //stator_T_total_outlet

            //stator_T_static_outlet

            //stator_P_total_outlet

            //stator_P_static_outlet        

            //stator_rho_total_outlet

            //stator_rho_static_outlet

            //stator_C_outlet

            //stator_Ctheta_outlet

            //stator_Cm_outlet

            //stator_alpha_outlet

            //stator_radius_outlet

            //stator_outlet_length_total

            //stator_outlet_length

            //stator_outlet_area

            //stator_outlet_area_total

            //stator_number_vanes

            //stator_solidity

            //stator_critical_area

            //stator_trailing_edge_thickness

            //stator_throat_length

            //stator_throat_area

            //stator_throat_radius

            //Reynolds_Number_Stator

            xlWorkBook1.SaveAs("c:\\Users\\luisc\\Desktop\\sCO2 Heat Balances C#\\Prueba_Luis.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        //Export Results to Power cycle for Real Performance Calculation
        ...
        public void Initialization_function()
        {
            ...
            T_total_outlet = Convert.ToDouble(this.textBox17.Text);
            ...
            this.textBox16.Text = working_fluid.Density.ToString();
            this.textBox15.Text = working_fluid.Enthalpy.ToString();
            this.textBox14.Text = working_fluid.Entropy.ToString();

            total_entalphy_difference = H_total_inlet - H_total_outlet;
            this.textBox34.Text = Convert.ToString(total_entalphy_difference * 1000);

            //eta_static calculation
            ...
            eta_static = (H_total_inlet - H_total_outlet) / (H_total_inlet - H_total_outlet_isoentropic);
            this.textBox12.Text = Convert.ToString(eta_static);
        ...
        public void Rotor_Calculation_function(Double head_coefficient1, Double flow_coefficient1)
        {
            ...
            if ((head_coefficient1==0) && (flow_coefficient1==0))
            {
            ...
            {
                head_coefficient = head_coefficient1;
                flow_coefficient = flow_coefficient1;
            }
        ...
        public void Stator_Calculation_function()
        {
            //5. STATOR INLET. 
        ...
        public void Enthalpy_Looses_Calculation_function()
        {
            ...
            //REAL Radial_Turbine Conditions calculation
            total_entalphy_difference_real = (total_entalphy_difference * 1000) + enthalpy_loss;

            H_total_outlet_real = ((H_total_inlet * 1000) - ((total_entalphy_difference) + (enthalpy_loss / 1000)) * 1000) / 1000;
            textBox33.Text = Convert.ToString(H_total_outlet_real);

            //Reatl Total Enthalpy difference
            textBox19.Text = Convert.ToString((H_total_inlet - H_total_outlet_real) * 1000);

            H_total_outlet_real_isoentropic = H_total_inlet - ((H_total_inlet - H_total_outlet_real) / turbine_efficiency);
            working_fluid.FindStatueWithHS(H_total_outlet_real_isoentropic * Molar_mass, S_total_inlet * Molar_mass);
            P_Total_outlet_real = working_fluid.Pressure;
            textBox36.Text = Convert.ToString(P_Total_outlet_real);

            working_fluid.FindStatueWithPH(P_Total_outlet_real, H_total_outlet_real * Molar_mass);
            T_total_outlet_real = working_fluid.Temperature;
            textBox32.Text = Convert.ToString(T_total_outlet_real);

            textBox35.Text = Convert.ToString(((H_total_inlet - H_total_outlet_real) * mass_flow_rate) - power);
            textBox37.Text = Convert.ToString((H_total_inlet - H_total_outlet_real) * mass_flow_rate);

            textBox38.Text = Convert.ToString(turbine_efficiency);

            textBox39.Text = Convert.ToString(enthalpy_loss);

            pressure_ratio_real = P_total_inlet / P_Total_outlet_real;
        ...
        public void Feasibility_Check_function()
        {
        ...
        public void Writting_Results()
        {
            ...
            Environment.NewLine + "eta_total: " + Convert.ToString(decimal.Round(Convert.ToDecimal(eta_total), 6, MidpointRounding.AwayFromZero)) +
            Environment.NewLine + "turbine_efficiency: " + Convert.ToString(decimal.Round(Convert.ToDecimal(turbine_efficiency), 6, MidpointRounding.AwayFromZero));
        ...
        public void Arrays_Storing_function(int index1)
        {
            flow_coefficient_array [index1] = flow_coefficient;
            head_coefficient_array [index1] = head_coefficient;
            turbine_efficiency_array [index1] = turbine_efficiency;
            turbine_number_array[index1] = index1;
        }

        //Optimum Head and Flow Coefficient Calculation
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            for (flow_coefficient = 0.1; flow_coefficient <= 0.41; flow_coefficient = flow_coefficient + 0.01)
            {
                for (head_coefficient = 0.7; head_coefficient <= 1.11; head_coefficient = head_coefficient + 0.01)
                {
                    Initialization_function();

                    Rotor_Calculation_function(head_coefficient, flow_coefficient);
                    ...
                    Arrays_Storing_function(index);

                    //Writting_Results_in_DataGrid();
            ...
            //maxValue = turbine_efficiency_array.Max();
            //maxIndex = turbine_efficiency_array.ToList().IndexOf(maxValue);
